...
prm =  CalcOperatorPrm_kato(outsideTemperature=28,max_time=max_time,i_max=2,i_min=0,heatTransferCoef_water=270,tau=30,p=0.35,p2=0.35,...
...
%測定ノイズ
variable.tubeNoise = 0.1*randn(size(variable.tubeGairan));
variable.almiNoise = 0.1*randn(size(variable.tubeGairan));
